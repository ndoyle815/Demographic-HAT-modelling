...
ActiveM = ACTIVEGM(location, :);
ActiveF = ACTIVEGF(location, :);
PassiveM = PASSIVEGM(location, :);
PassiveF = PASSIVEGF(location, :);
...
ActiveMQ1 = quantile(SampledActiveGenderM, [0.025 0.25 0.5 0.5 0.75 0.975]);
ActiveFQ1 = quantile(SampledActiveGenderF, [0.025 0.25 0.5 0.5 0.75 0.975]);
PassiveMQ1 = quantile(SampledPassiveGenderM, [0.025 0.25 0.5 0.5 0.75 0.975]);
PassiveFQ1 = quantile(SampledPassiveGenderF, [0.025 0.25 0.5 0.5 0.75 0.975]);
...
% ===== Active =====
subplot(2+AddNewInf, 1, 1)
s1 = scatter([20:22]+0.5-width./2, ActiveM(20:22), 80, MyBlue, 'Filled', 'o', 'MarkerEdgeColor', 'k');
hold on
s2 = scatter([20:22]+0.5+width./2, ActiveF(20:22), 80, MyRed, 'Filled', 'o', 'MarkerEdgeColor', 'k');
hold on
%Calls Kat's boxplot function
k1 = Katboxplot(ActiveMQ1, ActiveM, ShowYears, MyBlue, xall-width./2, xpos, xlabels, xminorpos,width);
hold on
k2 = Katboxplot(ActiveFQ1, ActiveF, ShowYears, MyRed, xall+width./2, xpos, xlabels, xminorpos,width);

legend([k1 k2 s1 s2],{'Model (M)', 'Model (F)', 'Data (M)', 'Data (F)'},'FontSize',14)
xlim([-0.5 23])
ylim([0, 1.15 * max([max(ActiveMQ1) max(ActiveFQ1)])])
...
s1 = scatter([20:22]+0.5-width./2, PassiveM(20:22), 80, MyBlue, 'Filled', 'o', 'MarkerEdgeColor', 'k', 'DisplayName', 'Data (M)');
hold on
s2 = scatter([20:22]+0.5+width./2, PassiveF(20:22), 80, MyRed, 'Filled', 'o', 'MarkerEdgeColor', 'k', 'DisplayName', 'Data (F)');
hold on
%Calls Kat's boxplot function
k1 = Katboxplot(PassiveMQ1, PassiveM, ShowYears, MyBlue, xall-width./2, xpos, xlabels, xminorpos, width);
hold on
k2 = Katboxplot(PassiveFQ1, PassiveF, ShowYears, MyRed, xall+width./2, xpos, xlabels, xminorpos, width);

legend([k1 k2 s1 s2],{'Model (M)', 'Model (F)', 'Data (M)', 'Data (F)'},'FontSize',14)
xlim([-0.5 23])
ylim([0, 1.15 * max([max(PassiveMQ1) max(PassiveFQ1)])])
